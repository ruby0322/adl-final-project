...
1. Key Symptoms: Identify the most critical symptoms that impact the diagnosis.
...
3. Final Diagnosis: Select the most appropriate diagnosis based on your reasoning.

Respond in the following format, do not include brackets:
Key Symptoms: {list the key symptoms}
