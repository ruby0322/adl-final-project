...
class ClassificationAgent(LocalModelAgent):
    ...
    def get_system_prompt() -> str:
        ...
        Provide your brief reasoning process within 100 words and final diagnosis base on the reasoning in the following format: <reasoning> # <number>. <diagnosis>""".strip()
    ...
    def get_fewshot_template(
        ...
        Now provide your brief reasoning process within 100 words and final diagnosis base on the reasoning in the following format: <reasoning> # <number>. <diagnosis>"""
        return strip_all_lines(prompt)
